    ...
    echo    '<article class="md-syntax">',
                ...
                "<form action='project/${data}/' method='POST'>",
                    ...
                    '<div class="buttons">',
                        ...
                        pog_html_button('btn-open',"<a target='_blank' href='https://latexonline.cc/compile?url=http://easylatex.francois.poguet.com/projects/${filename}.tex' >Open file</a>",'button'),
                    ...
                    '</div>',
                    '<div class="viewer">',
                        "<iframe class='viewer-wrapper' src='https://latexonline.cc/compile?url=http://easylatex.francois.poguet.com/projects/${filename}.tex'>",
                        '</iframe>',
                        '<div class="errors">',
                            '<h2>Markup errors</h2>',
